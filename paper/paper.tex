...
%
When uncertainty is present, the initial displacements $\mathbf{x}(0)$ and the initial velocities velocities $\mathbf{x}'(0)$ can be considered as part of corresponding feasible states sets $\mathcal{X}_0$ and  $\mathcal{V}_0$, respectively. %
%
