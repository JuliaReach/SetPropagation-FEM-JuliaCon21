...
%
The spring-mass system shown in Fig.~\ref{fig:diagram}, loaded with a Heaviside step function with uncertainties in load and initial conditions, can be easily modeled and solved using the code shown in Listing~\ref{ejemplo}. %
%
...
%
%
\begin{lstlisting}[caption=Example code for the spring-mass problem.,label=ejemplo, numbers=left, belowskip=4mm]
